...
from panda3d.core import Vec4, Vec3, WindowProperties, AmbientLight, DirectionalLight
...
class Game(ShowBase):
    def __init__(self):
        ...
        self.keyMap = {"up" : False,"down" : False,"left" : False,"right" : False,"shoot" : False}
        ...
        self.gameOverScreen = DirectDialog(frameSize = (-0.7, 0.7, -0.7, 0.7),
                                           fadeScreen = 0.4,
                                           relief = DGG.FLAT,
                                           frameTexture = "Models/Misc/stoneFrame.png")
        self.gameOverScreen.hide()

        self.font = loader.loadFont("Models/Wbxkomik.ttf")

        buttonImages = (
            loader.loadTexture("Models/Misc/UIButton.png"),
            loader.loadTexture("Models/Misc/UIButtonPressed.png"),
            loader.loadTexture("Models/Misc/UIButtonHighlighted.png"),
            loader.loadTexture("Models/Misc/UIButtonDisabled.png")
        )
        ...
        music = self.loader.loadMusic("Sounds/Defending-the-Princess-Haunted.ogg")
        music.setLoop(True)
